...
if("TRUE" STREQUAL "TRUE")
  set(turtlesim_SOURCE_PREFIX /home/alessio/workspaces/src/turtlesim)
  set(turtlesim_DEVEL_PREFIX /home/alessio/workspaces/devel)
  ...
  set(turtlesim_INSTALL_PREFIX /home/alessio/workspaces/install)
...
if(NOT "/home/alessio/workspaces/devel/include " STREQUAL " ")
  set(turtlesim_INCLUDE_DIRS "")
  set(_include_dirs "/home/alessio/workspaces/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlesim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alessio/workspaces/src/turtlesim/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/alessio/workspaces/devel/lib;/opt/ros/kinetic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND turtlesim_EXPORTED_TARGETS ${${turtlesim_dep}_EXPORTED_TARGETS})
endforeach()
